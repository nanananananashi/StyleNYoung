...
<body>
    ...
    <section class="container">
        ...
        <div class="links">
            Have an account: <a href="Land.php" style="color:#473C38">LOG IN HERE</a><br><br>
            <label>You will receive the confirmation mail to your email address associated with<br>account. 
                Please make sure to check your incoming email from us.</label>
        </div>
